...
const MySchedule = ({ 
  ...
  return (
    <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', minWidth: 0 }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2, gap: 2, px: isMobile ? 2 : 1, position: 'relative', flexShrink: 0, mr: 1 }}>
        {/* Empty box for spacing on desktop */}
        {!isMobile && <Box sx={{ visibility: 'hidden' }}><Button size="small">저장</Button></Box>}
